...
function loadDose() {
  ...
  managers.planStateManager.dose.setDisplayType(CONSTANT.DOSE_DISPLAY_TYPES.F, [
    componentId,
  ]);
  loadPri();
}
  ...
  <main>
    ...
    <div style="width: 1649px; margin: 20px auto 0">
      ...
      <div class="row">
        ...
        <button
          :style="{
            background: originModule.draggable[
        ...
        <button
          :style="{
            background: originModule.visible[
              draggableStateManager.DraggableElementType.origin
            ]
              ? activedColor
              : '',
      ...
      <div class="row">
        ...
        <button
          @click="() => imageCenter.addCenter(originModule.positionRef.value)"
        >
          Add
        </button>
      ...
      <div class="row">
        ...
        <button
          :style="{
            background: shotModule.draggable.primary ? activedColor : '',
          }"
        ...
        <button
          :style="{
            background: shotModule.visible.primary ? activedColor : '',
          }"
      ...
      <div class="row">
        <label>
          ShotID:
          <input
            :value="shotModule.shotId.value"
            @change="shotModule.setShotId"
          />
        </label>
        <label>
          X:<input
      ...
      <div class="row">
        ...
        <button
          :style="{
            background: frameModule.extractedDraggable.primary
              ? activedColor
              : '',
          }"
        ...
        <button
          :style="{
            background: frameModule.extractedVisible.primary
              ? activedColor
              : '',
          }"
        ...
        <button
          :style="{
            background: frameModule.fittingVisible.primary ? activedColor : '',
          }"
        ...
        <button
          :style="{
            background: frameModule.physicsVisible.primary ? activedColor : '',
          }"
          @click="frameModule.setPhysicsVisible"
        >
          Physics Visible
        </button>
        <button @click="frameModule.resetExtractedPoints">
        ...
        <label>
          Z:
          <input
            :value="frameModule.currFrameExtractedPosition.value[2]"
            readonly
          />
        </label>
      </div>
      ...
      <div class="row">
        ...
        <button
          :style="{
            background: couchModule.visible.primary ? activedColor : '',
          }"
      ...
      <div class="row">
        ...
        <button
          :style="{
            background: dosePtModule.draggable.primary ? activedColor : '',
          }"
        ...
        <button
          :style="{
            background: dosePtModule.visible.primary ? activedColor : '',
          }"
