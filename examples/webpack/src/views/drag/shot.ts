...
export default function initShotModule(
  ...
  function setShotId(e: Event) {
    ...
    planStateManager.shot.setCurrShotId(
      patientModelId,
      (shotId.value = target.value),
      [componentId]
    );
  ...
  function setNumber(e: Event) {
    ...
    shotManager.update(planId_P, unref(shotId), { number: unref(shotNumber) }, [
      componentId,
    ]);
  }
