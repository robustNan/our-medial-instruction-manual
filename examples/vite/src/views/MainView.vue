...
function changeAxisLayout(e: GlobalEventHandlersEventMap['change']): void {
  const { target } = e
  ...
  <main>
    ...
    <div style="width: 1649px; margin: 20px auto 0">
      <div class="row">
        ...
        <button :style="{ background: sliceSync ? 'gold' : '' }" @click="setSliceSync">
          Slice Sync
        </button>

        <button :style="{ background: pointSync ? 'gold' : '' }" @click="setPointSync">
          Point Sync
        </button>
